...
// Ha POST kérés érkezik, akkor kezeljük a jelszóváltoztatás és profil módosítás funkciókat
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['change_password'])) {
        ...
        // Ellenőrizzük, hogy az új jelszó és megerősítése egyezik-e
        if ($newPassword !== $confirmPassword) {
            ...
            if (password_verify($currentPassword, $hashedPassword)) {
                // Ha a jelenlegi jelszó helyes, hash-eljük az új jelszót bcrypt algoritmussal
    ...
    if (isset($_POST['update_profile'])) {
        ...
        // Frissítjük a userData változót a legfrissebb adatokkal
...
<!-- Toast üzenet megjelenítése sikeres műveletek esetén -->
