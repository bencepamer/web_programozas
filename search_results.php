...
if (isset($_GET['search'])) {
    ...
    // SQL lekérdezés előkészítése a kereséshez
...
// Ha a kedvenc gomb meg lett nyomva (AJAX kérés)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['like'])) {
    // Ellenőrizni, hogy be van-e jelentkezve a felhasználó (munkamenet kezelés)
    ...
    // Ellenőrizni, hogy még nincs-e kedvencnek hozzáadva az állat
