...
// Ha van token paraméter a GET kérésben
if (isset($_GET['token'])) {
    $token = $_GET['token'];

    // Ellenőrizzük, hogy a session-ben lévő activation_token egyezik-e a kapott tokennel
    if (isset($_SESSION['activation_token']) && $_SESSION['activation_token'] === $token) {
        ...
        $user_id = $pdo->lastInsertId(); // Az újonnan beszúrt user ID-je

        // Töröljük az aktivációs session változókat
        ...
        // Sikeres aktiválás oldal megjelenítése
        echo '
        <!DOCTYPE html>
        <html lang="hu">
        <head>
        ...
        // Hibás vagy lejárt aktivációs link
        echo '
        <!DOCTYPE html>
        <html lang="hu">
        <head>
    ...
    // Ha nincs token paraméter megadva a GET kérésben
    echo '
    <!DOCTYPE html>
    <html lang="hu">
    <head>
