...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($user) {
            ...
            $activation_link = "http://localhost/PET/reset_password.php?token=$resetToken";
                ...
                <table class="container" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="header" colspan="2">
                            <img src="http://localhost/PET/images/logo.png" alt="PET Adoption Logo" style="max-width: 150px; display: block; margin: 0 auto;">
                        </td>
                    </tr>
                    <tr>
...
<body>
    ...
    <div class="form-container">
        ...
        <!-- PHP kód által generált üzenetek megjelenítése -->
        ...
        <!-- Űrlap a jelszó visszaállítási e-mail küldéséhez -->
    ...
    <!-- JavaScript kód a toast üzenetek megjelenítéséhez -->
    <script>
        function showToast(message, type) {
            ...
            setTimeout(() => {
                toast.remove();
            }, 3000); // 3 másodperc múlva eltávolítj
