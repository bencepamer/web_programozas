...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['is_admin']) || $_SESSION['is_admin'] !== true) {
    header("Location: admin_login.php"); // Átirányítás a bejelentkezési oldalra, ha nem adminisztrátorként van bejelentkezve.
    exit;
}
?>
...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"> <!-- Bootstrap stíluslap betöltése -->
  <link href="css/admin_navbar.css" rel="stylesheet"> <!-- Egyedi stíluslap betöltése -->
</head>
